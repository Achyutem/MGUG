    ...
    <div>
      <section id="admissions" className="relative z-20 py-24 px-4">
        <div className="max-w-4xl mx-auto">
          <AnimatedCard>
            <ModernCard className="text-center" hover={false}>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">
                Ready to Begin Your Journey?
              </h2>
              <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
                Join thousands of students who are shaping the future at
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                ...
                <a href="https://admission.mgug.ac.in/doc/Prospectus_2025_Final_21-03-2025_Final.pdf">
                  <button className="px-6 sm:px-12 py-4 bg-gray-900/50 border border-gray-700 rounded-xl font-semibold text-lg hover:border-orange-500/50 hover:bg-gray-900/70 transition-all duration-300 w-auto">
                    Download Brochure
                  </button>
                </a>
              </div>
