        ...
        <div className="flex flex-col items-center">
          <div className="w-full max-w-5xl text-left">
            <h1 className="text-4xl font-bold mb-8 text-orange-400 text-center">
              {sgrcCommitteeTitles.heading.english}
            </h1>
                  ...
                  <thead>
                    <tr className="bg-orange-500/20 text-orange-400">
                      <th className="p-4 font-semibold rounded-tl-xl">
                        {sgrcCommitteeTitles.headers.srNo.english}
                      </th>
                      <th className="p-4 font-semibold">
                        {sgrcCommitteeTitles.headers.name.english}
                      </th>
                      <th className="p-4 font-semibold">
                        {sgrcCommitteeTitles.headers.designation.english}
                      </th>
                      <th className="p-4 font-semibold rounded-tr-xl">
                        {sgrcCommitteeTitles.headers.role.english}
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {sgrcCommitteeData.map(
                      ({ srNo, name, designation, role }) => (
                        ...
                        >
                          ...
                          <td className="p-4">{name.english}</td>
                          <td className="p-4">{designation.english}</td>
            ...
            <div className="mt-10 bg-sky-900/50 border-l-4 border-sky-400 p-6 rounded-lg text-base text-sky-200">
              ...
              <p className="mb-1">
                <strong>{ombudspersonData.name.english}</strong>
              </p>
              <p className="mb-1">{ombudspersonData.designation.english}</p>
